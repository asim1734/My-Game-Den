...
export const CommunityReviews = ({ gameId }) => {
    ...
    if (isError) {
        return (
            <Box p={4} bg="red.900" borderRadius="md" color="red.100" mt={8}>
        ...
        <VStack align="stretch" spacing={6} mt={10} mb={10}>
            ...
            <Box 
                ...
                sx={{
                    ...
                    '&::-webkit-scrollbar-track': { background: 'brand.900', borderRadius: '10px' },
                    ...
                    '&::-webkit-scrollbar-thumb:hover': { background: 'brand.400' },
                }}
            >
                <VStack align="stretch" spacing={4}>
                    {hasReviews ? (
                                ...
                                <VStack align="stretch" spacing={4}>
                                    <HStack justify="space-between" align="center">
                                        <HStack spacing={3}>
                                            <Avatar 
                                                size="sm" 
                                                name={review.userName || review.user?.username} 
                                                bg="brand.600"
                                                border="2px solid"
                        ...
                        >
                            <VStack>
                                <Text color="gray.500" fontSize="lg">No community reviews yet.</Text>
                                <Text color="gray.600" fontSize="sm">Be the first to share your thoughts above!</Text>
                            </VStack>
                        </Center>
                    )}
                </VStack>
